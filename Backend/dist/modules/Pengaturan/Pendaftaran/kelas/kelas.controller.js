...
const update_kelas_dto_1 = require("./dto/update-kelas.dto");
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KelasController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], KelasController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('super_admin'),
    __param(0, (0, common_1.Param)('id')),
